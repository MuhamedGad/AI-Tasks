...
def showfunc(start, end, algo):
    ...
    # if start == "Start" or end == "End" or algo == "Algorithm":
    #     print('Please Enter All Information')
    #     showfunc(start, end, algo)
...
end_city_Chossen['value']=('Tala','Alshohda','BerketAlseb3','Quesna','ShebinElkom','Minouf','Elbagoor','Ashmoon','Elsadat','KafrEl-Zayat','Basioun','Tanta','Qutur','El-MahallaEl-Kubra' ,'AsSantah','Samannoud','Zefta','Banha','Qalyub','AlQanatirAlKhayriyyah','ShubraAlKhaymah','Elkhankah','Kafrshokr','Toukh', 'ShibinElQanatir')
